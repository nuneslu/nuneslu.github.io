...
Here is a list of the GitHub projects from the papers I've co-authored:

- [3DiSS](https://github.com/PRBonn/3DiSS): Towards Generating Realistic 3D Semantic Training Data for Autonomous Driving
- [SfmPanOcc](https://github.com/PRBonn/SfmPanOcc): Vision-Based Panoptic Occupancy Prediction in Urban Environments
- [DiffTS](https://github.com/PRBonn/DiffTS): Tree Skeletonization from 3D Point Clouds by Denoising Diffusion
- [WaW](https://github.com/PRBonn/WeedsAreWeird): Zero-Shot Semantic Segmentation for Robots in Agriculture
- [SfmOcc](https://github.com/PRBonn/SfmOcc): Vision-Based 3D Semantic Occupancy Prediction in Urban Environments
...
- [SegContrast](https://github.com/PRBonn/segcontrast): 3D Point Cloud Feature Representation Learning through Self-supervised Segment Discrimination